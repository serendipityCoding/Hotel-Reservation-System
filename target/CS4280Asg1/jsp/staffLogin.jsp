...
<body>
	<div class="container">
		<form:form id="loginForm" cssClass="form-horizontal" modelAttribute="staffLogin" action="staffLoginProcess" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<form:label path="role" cssClass="radio-inline">
						<input type="radio"path="role"  name="role" value="2" checked="checked" >
						Hotel Manager
					</form:label>
  					<form:label path="role" cssClass="radio-inline">
